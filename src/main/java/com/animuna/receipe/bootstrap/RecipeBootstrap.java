package com.animuna.receipe.bootstrap;

import com.animuna.receipe.model.*;
import com.animuna.receipe.repositories.CategoryRepository;
import com.animuna.receipe.repositories.RecipeRepository;
import com.animuna.receipe.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        Notes note = new Notes(spcyGrldChknTacoNote);
        ...
        sautdZuchWdDill.setDescription("Sautéed zucchini");
        ...
        Notes note2 = new Notes(spcyGrldChknTacoNote);
